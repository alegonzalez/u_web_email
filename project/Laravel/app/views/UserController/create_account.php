	...
	<section class="container">
		<section class="row">
			<section class="col-md-5 col-md-offset-4">
				...
				<form  class="form_create_email form-inline"  name="Photo" method="POST" action="">
					...
					<section class="input_create_email input-group col-md-8 col-md-offset-2">
						...
						<input type="text" id="name" value="" name="UserName" class="form-control " placeholder="User Name" aria-describedby="basic-addon1">
					</a>
				...
				<button type="submit" class=" col-md-4 col-md-offset-3" id="btn_create_Email">Create Email</button>
